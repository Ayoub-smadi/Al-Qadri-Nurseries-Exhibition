 ...
 */
export const getGetSiteDataUrl = () => {
...
export const getSiteData = async (
  ...
  return customFetch<SiteDataResponse>(getGetSiteDataUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetSiteDataQueryKey = () => {
  return [`/api/site-data`] as const;
};

export const getGetSiteDataQueryOptions = <
  TData = Awaited<ReturnType<typeof getSiteData>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSiteData>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSiteDataQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSiteData>>> = ({
    signal,
  }) => getSiteData({ signal, ...requestOptions });
...
export type GetSiteDataQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSiteData>>
>;
export type GetSiteDataQueryError = ErrorType<unknown>;
...
>(options?: {
  ...
  const queryOptions = getGetSiteDataQueryOptions(options);
...
/**
 * @summary Save site data
 */
export const getSaveSiteDataUrl = () => {
  return `/api/site-data`;
};

export const saveSiteData = async (
  siteDataBody: SiteDataBody,
  options?: RequestInit,
): Promise<SiteDataResponse> => {
  return customFetch<SiteDataResponse>(getSaveSiteDataUrl(), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(siteDataBody),
  });
};

export const getSaveSiteDataMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof saveSiteData>>,
    TError,
    { data: BodyType<SiteDataBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["saveSiteData"];
  ...
  > = (props) => {
    ...
    return saveSiteData(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SaveSiteDataMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveSiteData>>
>;
export type SaveSiteDataMutationBody = BodyType<SiteDataBody>;
export type SaveSiteDataMutationError = ErrorType<unknown>;

/**
 * @summary Save site data
 */
export const useSaveSiteData = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSaveSiteDataMutationOptions(options));
};
