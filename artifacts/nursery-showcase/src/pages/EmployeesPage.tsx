...
export default function EmployeesPage() {
  ...
  const save = async () => {
    if (!draft.name.trim()) return toast.error("اكتب اسم الموظف");
    setSaving(true);
    try {
